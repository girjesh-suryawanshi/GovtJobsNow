...
export default function ExamCalendar({ isOpen, onClose }: ExamCalendarProps) {
  ...
  const [exams] = useState<ExamEvent[]>([
    ...
    },
    {
      ...
      venue: 'Delhi, Mumbai, Bangalore, Chennai',
      type: 'preliminary',
      registrationDeadline: '2025-02-05',
      syllabus: ['English Language', 'Quantitative Aptitude', 'Reasoning Ability'],
      difficulty: 'medium',
      expectedCandidates: 200000,
      fees: '₹175',
      isRegistered: false
    },
    {
      id: '3',
      title: 'Railway Group D CBT',
      ...
      difficulty: 'easy',
      expectedCandidates: 300000,
      fees: '₹250',
      isRegistered: true
    },
    {
      id: '4',
      title: 'UPSC Civil Services Interview',
      department: 'Union Public Service Commission',
      date: '2025-03-05',
      time: '9:00 AM onwards',
      venue: 'UPSC Bhawan, New Delhi',
      type: 'interview',
      syllabus: ['Current Affairs', 'Optional Subject', 'General Studies'],
      difficulty: 'hard',
      expectedCandidates: 2000,
      fees: '₹200',
      isRegistered: false
    },
    {
      id: '5',
      title: 'SBI Clerk Main Exam',
      ...
      syllabus: ['General Awareness', 'General English', 'Quantitative Aptitude', 'Reasoning & Computer'],
      difficulty: 'medium',
      expectedCandidates: 75000,
      fees: '₹150',
      isRegistered: true
    }
  ]);
