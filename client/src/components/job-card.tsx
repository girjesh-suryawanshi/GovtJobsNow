...
import { Share2, Target, Bookmark } from "lucide-react";
...
interface JobCardProps {
  job: Job;
  onClick?: () => void;         // kept for backward-compat (ignored — navigation used)
  onCompare?: () => void;
  onTrack?: () => void;
  isComparing?: boolean;
}

export default function JobCard({ job, onCompare, onTrack, isComparing = false }: JobCardProps) {
      ...
      {showEligibility && (
        ...
        >
          ...
          {eligibility.isEligible
            ...
            : eligibility.reason || "You may not meet all criteria"}
        </div>
      )}
      ...
      <div className="card-footer-bar">
        ...
        <div style={{ display: "flex", gap: "6px", alignItems: "center" }}>
          ...
          <button
            ...
            aria-label="Save job"
          >
            <Bookmark style={{ width: "13px", height: "13px", fill: isSaved ? "#f59e0b" : "none" }} />
          </button>
            ...
            trigger={
              <button
                ...
                style={{
                  background: "transparent", border: "1.5px solid var(--gjn-border)",
                  borderRadius: "6px", padding: "5px 9px", cursor: "pointer",
                  color: "var(--gjn-muted)", transition: "all 0.15s",
                }}
