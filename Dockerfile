...
RUN npx vite build && npx esbuild server/index.ts --platform=node --bundle --format=esm --outdir=dist --packages=external --define:process.env.NODE_ENV='"production"' --define:import.meta.dirname='"/app/dist"'
